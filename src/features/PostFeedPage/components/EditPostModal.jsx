  ...
  return (
    <div className="fixed p-4 left-0 right-0 top-0 h-screen z-50 flex justify-center items-center bg-background-dim">
      <div
        ...
        className="w-2/5 md:w-3/5 sm:w-full  flex flex-col bg-nav-background dark:bg-dark-bg dark:text-dark-txt-primary rounded-lg drop-shadow-2xl divide-y divide-blue-200"
      >
        <div className="p-4">
        ...
        <div className="p-4">
          <div className="flex flex-col gap-4 grow">
            ...
            <div className="flex items-center gap-4 grow">
              ...
              />
              <input
                className="grow focus:outline-none font-light text-txt-secondary-color dark:bg-dark-bg"
              ...
              >
                ...
                {showEmojis ? (
                  <div
                    ...
                    className="absolute w-48 p-4 flex flex-wrap justify-center items-center gap-1 rounded-lg  bg-secondary-background dark:bg-dark-bg-paper"
                  >
                    {emojiLib.map((el) => {
                      return (
