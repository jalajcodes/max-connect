    ...
    <Fragment>
      {user ? (
        <div
          ...
          className="flex flex-col gap-4 bg-nav-background dark:bg-dark-secondary-background dark:text-dark-txt-primary rounded-lg drop-shadow-2xl p-5"
        >
          {/** post header */}
          <div className="flex gap-4  flex-grow">
            ...
            <div className="flex justify-between flex-grow">
              <div className="flex flex-col">
                ...
                <p className="text-xs dark:text-dark-txt-secondary text-txt-secondary-color">
              ...
              <div className="relative">
                ...
                {openMenu ? (
                  <div ref={menuRef} className="absolute right-0">
                    <div className="w-40 text-txt-secondary-color dark:text-dark-txt-secondary bg-secondary-background dark:bg-dark-bg-paper  border-gray-200 dark:border-none rounded-lg">
            ...
            <div
              onClick={() => {
                navigator.clipboard.writeText(
                  `http://${window.location.href.split("/")[2]}/post/${_id}`
                );
            ...
            <div className="flex gap-3 flex-col border-t-2  pt-6">
              ...
              <div className="flex w-full  shadow-sm  rounded-md  ">
                <input
                  ...
                  className="w-full border border-txt-hover-color dark:bg-dark-bg dark:text-dark-txt-secondary focus:border-primary active:border-primary active:outline-none focus:outline-none rounded-l-md p-1.5 px-3"
                  type="text"
                ...
                <button
                  ...
                  className="text-white bg-primary font-medium rounded-r-md text-sm px-4 text-center"
                >
                  Post
                </button>
              </div>
