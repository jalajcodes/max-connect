          ...
          <div className="ml-auto relative">
            ...
            {openMenuModal ? (
              <div ref={commentMenuRef} className="absolute right-0">
                <div className="w-24  text-txt-secondary-color dark:text-dark-txt-secondary bg-secondary-background dark:bg-dark-bg-paper rounded-lg">
                  {authUser._id === user._id ? (
                    <button
                      onClick={() => {
                        setIsEdit(true);
        ...
        <div className="flex flex-col gap-1 px-3">
          {!isEdit ? (
            ...
            <div className="w-full flex flex-col gap-2 ">
              <input
                className="w-full bg-background dark:bg-dark-bg dark:text-dark-txt-secondary mt-1  border border-txt-hover-color  active:outline-none focus:outline-none rounded-md py-0.5 px-3"
                value={editInput}
                type="text"
              ...
              <div className="flex gap-1 ml-auto">
                <button
                  ...
                  className="text-white bg-red-500 focus:outline-none rounded-md text-sm px-4 py-1 text-center"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="text-white bg-primary font-medium rounded-md text-sm px-4 py-1 text-center"
                >
                  Post
                </button>
              </div>
          ...
          {showReply ? (
            <div className="w-full flex flex-col gap-2 ">
              <input
                ...
                className="w-full bg-background dark:text-dark-txt-secondary dark:bg-dark-bg mt-1  border border-txt-hover-color  active:outline-none focus:outline-none rounded-md py-0.5 px-3"
                type="text"
              ...
              <div className="flex gap-1 ml-auto">
                <button
                  ...
                  className="text-white bg-red-500 rounded-md text-sm px-4 py-1 text-center"
                >
                  Cancel
                </button>
                <button
