      ...
      >
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex justify-between gap-4'>
            ...
            <textarea
              className='px-2 focus:outline-none dark:bg-dark-bg dark:text-dark-txt-primary'
              value={userData.bio}
              onChange={(e) =>
          ...
          <div className='flex gap-4'>
            ...
            <input
              className='flex-1 border border-solid border-txt-secondary-color dark:bg-dark-secondary-background dark:text-dark-txt-primary rounded-md px-2 focus:outline-none'
              value={userData.link}
              onChange={(e) =>
