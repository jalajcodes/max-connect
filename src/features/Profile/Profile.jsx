    ...
    <>
      ...
      {openFollowModal.length > 0 ? (
        <div className="h-screen w-screen fixed flex justify-center items-center z-50 bg-background-dim">
          <div
            ref={openFollowRef}
            className="flex flex-col gap-4 p-6 h-3/5 z-50 dark:bg-dark-secondary-background overflow-y-auto rounded-xl  sm:w-9/12  w-1/3 bg-background"
          >
              ...
              return (
                ...
                >
                  <img
                    ...
                    alt="user pic"
                  />
                  <p className="font-medium dark:text-dark-txt-secondary text-lg text-txt-secondary-color">
      ...
      <main className="p-2 mt-4">
        ...
        <div className="flex justify-center">
          ...
          <div className="flex flex-col w-2/5  xl:3/5 lg:w-4/5 md:4/5 sm:w-full  gap-4 ">
            {/* profile */}
            <div className="flex justify-around items-center  bg-nav-background dark:bg-dark-secondary-background dark:text-dark-txt-primary gap-4  rounded-lg drop-shadow-2xl  p-5">
              <img
            ...
            <div className="flex justify-evenly items-center sm:text-xs  bg-nav-background dark:bg-dark-secondary-background dark:text-dark-txt-primary gap-10 rounded-lg drop-shadow-2xl  p-4 sm:p-3 ">
              <div
                onClick={() => setSubNav("posts")}
            ...
            {subNav === "posts" ? (
              <div className="flex flex-col gap-4">
                {[...allPosts.filter((el) => el.userId === user?._id)]
                  .length === 0 ? (
                  <div className="bg-nav-background dark:bg-dark-secondary-background dark:text-dark-txt-primary p-3 rounded-lg drop-shadow-2xl">
